...
@auth.route('/java')
def java():
    num_questions = 5  # Specify the number of questions needed
...
#     difficulty_dict = {}
#     for q in questions:
#         difficulty_dict[q] = mongo2.db[subject].find_one({'Question': q})['Difficulty']
...
#         answer = mongo2.db[subject].find_one({'Question': question})['Answer']
#         difficulty = difficulty_dict[question]

#         user_embedding = sentence_transformer.encode([user_answer])
#         actual_embedding = sentence_transformer.encode([answer])
...
#     total_easy_questions = list(difficulty_dict.values()).count('Easy')
#     total_medium_questions = list(difficulty_dict.values()).count('Medium')
#     total_hard_questions = list(difficulty_dict.values()).count('Hard')

#     return render_template('result.html', correct=correct, total_questions=total_questions,
...
#                            correct_medium_questions=correct_medium_questions, correct_hard_questions=correct_hard_questions)
...
openai.api_key="Add_your_openAI_apikey"
